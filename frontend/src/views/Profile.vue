        ...
        <form>
          <div class="form-input">
            <ValidationProvider rules="required|min:3|max:15" v-slot="v">
              <label>
                <p class="form-label"><img class="form-icon" src="../assets/icon-tag.svg" alt="Tag Icon">Name</p>
          ...
          <div class="form-input">
            <ValidationProvider rules="required|email" v-slot="v">
              <label>
                <p class="form-label"><img class="form-icon" src="../assets/icon-mail.svg" alt="E-Mail Icon">E-Mail</p>
      ...
      <div>
        ...
        <div class="form-input">
          <ValidationProvider rules="min:8" v-slot="v">
            <label>
              <p class="form-label"><img class="form-icon" src="../assets/icon-lock.svg" alt="Lock Icon">New Password</p>
